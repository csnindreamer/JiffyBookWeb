'use client'
import { FunctionComponent, useEffect,useContext,useState,useRef } from "react";
...
const TestBusinessReg:  React.FC<{ user: any }> = ({ user }) =>  {
...
console.log(" called heree",value)
...
export default withAuth(TestBusinessReg);