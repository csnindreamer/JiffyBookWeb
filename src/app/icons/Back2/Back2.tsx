...
export const Back2 = ({ className }: Props): JSX.Element => {
  return (
    <svg
      className={`back-2 ${className}`}
      fill="none"
      height="44"
      viewBox="0 0 44 44"
      width="44"
    ...
    >
      <g className="g" filter="url(#filter0_d_134_445)">
        <circle className="circle" cx="22" cy="18" fill="white" r="18" />
      </g>
      <g className="g" clipPath="url(#clip0_134_445)">
        <path
          className="path"
      ...
      <defs className="defs">
        ...
        >
          ...
          />
          <feBlend className="fe-blend" in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_134_445" />
          <feBlend
            className="fe-blend"
            in="SourceGraphic"
            in2="effect1_dropShadow_134_445"
            mode="normal"
            result="shape"
          />
        </filter>
        <clipPath className="clip-path" id="clip0_134_445">
